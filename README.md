...
**Researcher:** As a researcher, I want to access and compare data sets to support my hypotheses. The option to utilize a database with multiple data sets where I can be easily compare and manipulate data will streamline my research efforts. 
