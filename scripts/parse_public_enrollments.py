...
"""
Notes:
AUN (from excel), county (mapped from institutions), year (excel), enrollment (excel)
aggregate by county
"""
"""
Sample:
...
def extract():
    ...
    """
    URL = 'http://data.pa.gov/resource/bz3e-dm5u.json'
...
def transform(data):
    ...
    enrollment_df = pd.read_excel('~/DataDetective/data/Enrollments_Public_Schools_93_13', sheetname='Sheet2')
    data_points = []
    county_data_set = []
